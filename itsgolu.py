...
# ==================================================
# REQUIRED ENTRY POINT (PATCHED)
# ==================================================
async def download_video(url, cmd, name):
    """
    Wrapper used by main bot logic.
    Priority:
    1) ffmpeg
    2) aria2
    """
    ...
    outputs = [name, f"{name}.mp4", f"{name}.webm"]
    ...
    raise Exception("Download failed (ffmpeg + aria2)")

print("DEBUG itsgolu loaded | download_video:", "download_video" in globals())
