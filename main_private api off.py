# 🔧 Standard Library NEW itsgolu newCP PRIVATE api 4-dec-2025
import os
import re
import sys
import time
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            if "acecwply" in url:
                ...
                api_url_call = f"https://itsgolu-private-2026.vercel.app/itsgolu?url={url}@ITSGOLU_OFFICIAL&user_id={user_id}"
                keys_string = ""
                mpd = None
                try:
